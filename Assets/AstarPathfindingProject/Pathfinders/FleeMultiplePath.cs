...
namespace Pathfinding {
	...
	/// </code>
	/// </summary>
	public class FleeMultiplePath : RandomPath {
		/// <summary>
		/// Default constructor.
		/// Do not use this. Instead use the static Construct method which can handle path pooling.
		/// </summary>
		public FleeMultiplePath() {}
		...
		/// </summary>
		public static FleeMultiplePath Construct (Vector3 start, Vector3[] avoid, int searchLength, OnPathDelegate callback = null) {
