...
public enum JOB_TYPE { NONE, UNDERMINE, ENERGY_RECOVERY_URGENT, FULLNESS_RECOVERY_URGENT, ENERGY_RECOVERY_NORMAL, FULLNESS_RECOVERY_NORMAL, HAPPINESS_RECOVERY, REMOVE_STATUS, RESTRAIN
        ...
        , DISPOSE_FOOD_PILE, SNATCH_RESTRAIN, KLEPTOMANIAC_STEAL, LAZY_NAP, FIND_AFFAIR, ABSORB_CRYSTAL, MINE_ORE, FIND_FISH, TILL_TILE, SHEAR_ANIMAL, SKIN_ANIMAL, HARVEST_CROPS, CRAFT_WEAPON, CHOP_WOOD, MINE_STONE, RECUPERATE, HEALER_CURE
        , GATHER_HERB, CREATE_HOSPICE_POTION, CREATE_HOSPICE_ANTIDOTE,
}
...
public enum PLAYER_SKILL_TYPE { NONE = 0, LYCANTHROPY = 1, KLEPTOMANIA = 2, VAMPIRISM = 3, UNFAITHFULNESS = 4, CANNIBALISM = 5, ZAP = 6,
    ...
    PLANT_GERM = 70, MEDDLER = 71, SNOOPER = 72, CRYPT = 73, KENNEL = 74, OSTRACIZER = 75, TORTURE_CHAMBERS = 76, DEMONIC_PRISON = 77,
