...
public enum TILE_OBJECT_TYPE {
    ...
    BEHOLDER_TILE_OBJECT = 174,
    BIOLAB_TILE_OBJECT = 175,
    IMP_HUT_TILE_OBJECT = 176,
    MEDDLER_TILE_OBJECT = 177,
    CRYPT_TILE_OBJECT = 178,
    TORTURE_CHAMBERS_TILE_OBJECT = 179,
    DEMONIC_STRUCTURE_BLOCKER_TILE_OBJECT = 180,
    KENNEL_TILE_OBJECT = 181,
}
...
public enum PLAYER_SKILL_TYPE { NONE = 0, LYCANTHROPY = 1, KLEPTOMANIA = 2, VAMPIRISM = 3, UNFAITHFULNESS = 4, CANNIBALISM = 5, ZAP = 6,
    ...
    UPGRADE_PORTAL = 201, DESTROY_STRUCTURE = 202, DIRE_WOLF = 203, SPAWN_NECRONOMICON = 204,
}
...
public enum PLAYER_ARCHETYPE { Normal, Ravager, Lich, Puppet_Master, Tutorial, Icalawa, Affatt, Scenario }
