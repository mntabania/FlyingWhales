...
public enum JOB_TYPE { NONE, UNDERMINE, ENERGY_RECOVERY_URGENT, FULLNESS_RECOVERY_URGENT, ENERGY_RECOVERY_NORMAL, FULLNESS_RECOVERY_NORMAL, HAPPINESS_RECOVERY, REMOVE_STATUS, RESTRAIN
        ...
        , PATROL, OBTAIN_PERSONAL_ITEM, MOVE_CHARACTER, HUNT_PSYCHOPATH_VICTIM, INSPECT, DOUSE_FIRE, COMMIT_SUICIDE, SEDUCE, REPAIR
        ...
        , IDLE_RETURN_HOME, IDLE_NAP, IDLE_SIT, IDLE_STAND, IDLE_GO_TO_INN, IDLE, COMBINE_STOCKPILE, ROAM_AROUND_TERRITORY, ROAM_AROUND_CORRUPTION, ROAM_AROUND_PORTAL, ROAM_AROUND_TILE, ROAM_AROUND_STRUCTURE, RETURN_TERRITORY, RETURN_PORTAL
        ...
        , DECREASE_MOOD, DISABLE, MONSTER_EAT, ARSON, SEEK_SHELTER, DARK_RITUAL, CULTIST_TRANSFORM, CULTIST_POISON, CULTIST_BOOBY_TRAP, JOIN_PARTY, EXPLORE, EXTERMINATE, RESCUE, RELEASE_CHARACTER, COUNTERATTACK_PARTY
}
...
public enum SPELL_TYPE { NONE, LYCANTHROPY, KLEPTOMANIA, VAMPIRISM, UNFAITHFULNESS, CANNIBALISM, ZAP,
    DESTROY, RAISE_DEAD, METEOR, IGNITE, CURSED_OBJECT, AGORAPHOBIA, ALCOHOLIC, PLAGUE,
