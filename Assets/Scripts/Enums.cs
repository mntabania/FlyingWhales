...
public enum JOB_TYPE { NONE, UNDERMINE, ENERGY_RECOVERY_URGENT, FULLNESS_RECOVERY_URGENT, ENERGY_RECOVERY_NORMAL, FULLNESS_RECOVERY_NORMAL, HAPPINESS_RECOVERY, REMOVE_STATUS, RESTRAIN
        ...
        , BRAWL, PLACE_TRAP, SPREAD_RUMOR, CONFIRM_RUMOR, OPEN_CHEST, TEND_FARM, VISIT_DIFFERENT_REGION,
}
...
public enum SPELL_TYPE { NONE, LYCANTHROPY, KLEPTOMANIA, VAMPIRISM, UNFAITHFULNESS, CANNIBALISM, ZAP,
    ...
    STOP, SEIZE_OBJECT, SEIZE_CHARACTER, SEIZE_MONSTER, RETURN_TO_PORTAL, DEFEND, HARASS, INVADE, LEARN_SPELL, CHANGE_COMBAT_MODE, BUILD_DEMONIC_STRUCTURE, AFFLICT, ACTIVATE_TILE_OBJECT,
    BREED_MONSTER, END_RAID, END_HARASS, END_INVADE, INTERFERE, COWARDICE, PYROPHOBIA, NARCOLEPSY,
    PLANT_GERM, THE_GOADER, THE_EYE, THE_CRYPT, THE_KENNEL, THE_SPIRE, TORTURE_CHAMBER, DEMONIC_PRISON,
    ...
    MUSIC_HATER, THE_PROFANE, ABDUCT, ANIMATE, GLUTTONY
}
...
public enum EMOTION { None, Fear, Approval, Embarassment, Disgust, Anger, Betrayal, Concern, Disappointment, Scorn, Sadness, Threatened, Arousal, Disinterest, Despair, Shock, Resentment, Disapproval, Gratefulness, Rage }
