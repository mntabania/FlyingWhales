...
public class Party : ILogFiller, ISavable, IJobOwner {
    ...
    private void OnAddMemberThatJoinedQuest(Character character) {
        ...
        character.combatComponent.combatBehaviourParent?.OnCharacterJoinedPartyQuest(character, currentQuest.partyQuestType);
    ...
    private void OnRemoveMemberThatJoinedQuest(Character character, bool broadcastSignal) {
        ...
        if (isActive) {
            character.combatComponent.combatBehaviourParent?.OnCharacterLeftPartyQuest(character, currentQuest.partyQuestType);
        } else {
            character.combatComponent.combatBehaviourParent?.OnCharacterLeftPartyQuest(character, prevQuestType);
        }
