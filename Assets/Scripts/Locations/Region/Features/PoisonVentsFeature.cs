...
namespace Locations.Features {
    public class PoisonVentsFeature : TileFeature {
        ...
        public PoisonVentsFeature() {
            name = "Poison Vents";
            description = "This region has 3 to 4 Poison Vents.";
        ...
        private void CreateNewVent() {
            ...
            if (choices.Count > 0) {
                TileObject tileObject =
                    InnerMapManager.Instance.CreateNewTileObject<TileObject>(TILE_OBJECT_TYPE.POISON_VENT);
