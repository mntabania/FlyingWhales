...
public class BallLightningTileObject : MovingTileObject {
    ...
    protected override bool TryGetGridTileLocation(out LocationGridTile tile) {
        if (mapVisual != null) {
            BallLightningMapObjectVisual ballLightningMapObjectVisual = mapVisual as BallLightningMapObjectVisual;
            if (ballLightningMapObjectVisual.isSpawned) {
                tile = ballLightningMapObjectVisual.gridTileLocation;
                return true;
            }
        }
        tile = null;
