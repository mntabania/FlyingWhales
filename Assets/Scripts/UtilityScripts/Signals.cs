...
public static class Signals {
    ...
    public static string FORCE_CANCEL_ALL_JOBS_TARGETING_POI_EXCEPT_ACTOR = "OnForceCancelAllJobsTargetingPOIExceptActor"; //Parameters (Character target, string cause)
