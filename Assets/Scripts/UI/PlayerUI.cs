...
public class PlayerUI : BaseMonoBehaviour {
    ...
    private void CreateItemsForTesting() {
        TILE_OBJECT_TYPE[] items = new[] {
            ...
            TILE_OBJECT_TYPE.TREASURE_CHEST, TILE_OBJECT_TYPE.ICE, TILE_OBJECT_TYPE.HERB_PLANT, TILE_OBJECT_TYPE.ANIMAL_MEAT, TILE_OBJECT_TYPE.PROFESSION_PEDESTAL, TILE_OBJECT_TYPE.TOOL
        };
        for (int i = 0; i < items.Length; i++) {
