...
public class PlayerUI : BaseMonoBehaviour {
    ...
    private void CreateItemsForTesting() {
        TILE_OBJECT_TYPE[] items = new[] {
            ...
            TILE_OBJECT_TYPE.MITHRIL_SWORD, TILE_OBJECT_TYPE.MINK_SHIRT, TILE_OBJECT_TYPE.SPIDER_SILK_SHIRT,
            TILE_OBJECT_TYPE.BELT, TILE_OBJECT_TYPE.BRACER, TILE_OBJECT_TYPE.COPPER_ARMOR, TILE_OBJECT_TYPE.IRON_ARMOR,
            ...
            TILE_OBJECT_TYPE.RABBIT_CLOTH, TILE_OBJECT_TYPE.WOLF_HIDE, TILE_OBJECT_TYPE.RABBIT_SHIRT, TILE_OBJECT_TYPE.WOLF_HIDE_ARMOR, TILE_OBJECT_TYPE.BOAR_HIDE, TILE_OBJECT_TYPE.BOAR_HIDE_ARMOR,
            TILE_OBJECT_TYPE.BEAR_HIDE, TILE_OBJECT_TYPE.MOONCRAWLER_CLOTH, TILE_OBJECT_TYPE.MINK_CLOTH, TILE_OBJECT_TYPE.BEAR_DEN, TILE_OBJECT_TYPE.BOAR_DEN, TILE_OBJECT_TYPE.WOLF_DEN,
        };
