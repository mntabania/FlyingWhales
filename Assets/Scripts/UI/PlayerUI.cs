...
public class PlayerUI : BaseMonoBehaviour {
    ...
    private void CreateItemsForTesting() {
        TILE_OBJECT_TYPE[] items = new[] {
            ...
            TILE_OBJECT_TYPE.POWER_CRYSTAL, TILE_OBJECT_TYPE.CORN, TILE_OBJECT_TYPE.POTATO, TILE_OBJECT_TYPE.PINEAPPLE,
            TILE_OBJECT_TYPE.ICEBERRY, TILE_OBJECT_TYPE.HYPNO_HERB,
         };
