...
public class CharacterInfoUI : InfoUIBase {
    ...
    public void ShowCharacterTestingInfo() {
        ...
        summary = $"{summary}{"\nHappiness Time: " + (activeCharacter.needsComponent.happinessForcedTick == 0 ? "N/A" : GameManager.ConvertTickToTime(activeCharacter.needsComponent.happinessForcedTick))}";
        summary = $"{summary}{"\n2nd Happiness Time: " + (activeCharacter.needsComponent.happinessSecondForcedTick == 0 ? "N/A" : GameManager.ConvertTickToTime(activeCharacter.needsComponent.happinessSecondForcedTick))}";
