...
namespace Quests {
    public class EliminateAllVillagers : ReactionQuest {
        ...
        protected override void ConstructSteps() {
            ...
            _eliminateVillagerStep.SetObjectsToCenter((QuestManager.Instance.winConditionTracker as TutorialWinConditionTracker).villagersToEliminate.Count > 0
                ? (QuestManager.Instance.winConditionTracker as TutorialWinConditionTracker).villagersToEliminate.Select(x => x as ISelectable).ToList()
