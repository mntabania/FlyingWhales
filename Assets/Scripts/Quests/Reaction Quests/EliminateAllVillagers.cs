...
namespace Quests {
    public class EliminateAllVillagers : ReactionQuest {
        ...
        protected override void ConstructSteps() {
            ...
            _eliminateVillagerStep.SetObjectsToCenter(QuestManager.Instance.eliminateVillagerTracker.villagersToEliminate.Count > 0
                ? QuestManager.Instance.eliminateVillagerTracker.villagersToEliminate.Select(x => x as ISelectable).ToList()
