    ...
    public class SurviveCounterattack : TutorialQuest {
        ...
        protected override void ConstructSteps() {
            steps = new List<QuestStepCollection>() {
                new QuestStepCollection(new ClickOnCharacterStep("Find the heroic party", validityChecker: IsCharacterPartOfHeroicParty)),
                new QuestStepCollection(new EliminateCharacterStep("Eliminate all threats", targets: PlayerManager.Instance.player.threatComponent.attackingCharacters.ToArray())) 
            };
        }
