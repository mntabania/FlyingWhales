    ...
    public class ShareAnIntel : BonusTutorial {
        ...
        protected override bool HasMetAllCriteria() {
            ...
            if (hasMetAllCriteria) {
                return PlayerSkillManager.Instance.GetPlayerSkillData(PLAYER_SKILL_TYPE.BEHOLDER).isInUse;
            }
            return false;
        }
        #endregion
        ...
        protected override void MakeAvailable() {
            if (!PlayerManager.Instance.player.playerSettlement.HasStructure(STRUCTURE_TYPE.BEHOLDER)) {
                 SkillData spellData = PlayerSkillManager.Instance.GetPlayerSkillData(PLAYER_SKILL_TYPE.BEHOLDER);
        ...
        protected override void ConstructSteps() {
            ...
            if (!PlayerManager.Instance.player.playerSettlement.HasStructure(STRUCTURE_TYPE.BEHOLDER)) {
                ...
                QuestStepCollection buildCollection = new QuestStepCollection(
                    ...
                    new StructureBuiltStep(STRUCTURE_TYPE.BEHOLDER, "Place on an unoccupied Area")
                );
