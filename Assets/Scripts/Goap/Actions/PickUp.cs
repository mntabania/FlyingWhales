        ...
        if(target is TileObject targetTileObject) {
            if(targetTileObject is Heirloom && job != null && job.jobType == JOB_TYPE.DROP_ITEM_PARTY) { //|| job.jobType == JOB_TYPE.DROP_ITEM
                ...
                if (targetTileObject.characterOwner == null) {
                    ...
                    } else if (actor.homeSettlement != null && targetTileObject.gridTileLocation != null && targetTileObject.gridTileLocation.parentArea.settlementOnTile == actor.homeSettlement) {
                    ...
                    } else if (!actor.isFactionless && !actor.isVagrantOrFactionless && targetTileObject.gridTileLocation != null && targetTileObject.gridTileLocation.parentArea.settlementOnTile != null
                         && targetTileObject.gridTileLocation.parentArea.settlementOnTile.owner == actor.faction) {
