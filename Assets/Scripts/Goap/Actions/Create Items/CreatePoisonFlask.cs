...
public class CreatePoisonFlask : GoapAction {

    public CreatePoisonFlask() : base(INTERACTION_TYPE.CREATE_POISON_FLASK) {
    ...
    protected override void ConstructBasePreconditionsAndEffects() {
        ...
        AddExpectedEffect(new GoapEffect(GOAP_EFFECT_CONDITION.HAS_POI, "Poison Flask", false, GOAP_EFFECT_TARGET.ACTOR));
    }
    ...
    public void AfterCreateSuccess(ActualGoapNode goapNode) {
        ...
        if(actor.HasItem(TILE_OBJECT_TYPE.HERB_PLANT) && actor.HasItem(TILE_OBJECT_TYPE.WATER_FLASK)) {
            actor.ObtainItem(InnerMapManager.Instance.CreateNewTileObject<TileObject>(TILE_OBJECT_TYPE.POISON_FLASK));
