...
public class CraftFurnitureStone : GoapAction {
    ...
    public CraftFurnitureStone() : base(INTERACTION_TYPE.CRAFT_FURNITURE_STONE) {
    ...
    protected override void ConstructBasePreconditionsAndEffects() {
        SetPrecondition(new GoapEffect(GOAP_EFFECT_CONDITION.BUY_OBJECT, "Stone Pile", false, GOAP_EFFECT_TARGET.ACTOR), HasStone);
    }
    ...
    public override void OnActionStarted(ActualGoapNode node) {
        TileObject stonePile = node.actor.GetItem(TILE_OBJECT_TYPE.STONE_PILE);
        if (stonePile != null) {
    ...
    public void PreCraftSuccess(ActualGoapNode goapNode) {
        ...
        List<StonePile> allPiles = RuinarchListPool<StonePile>.Claim();
