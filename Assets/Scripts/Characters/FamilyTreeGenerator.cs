...
public static class FamilyTreeGenerator {
    ...
    public static FamilyTree GenerateFamilyTree(RACE race) {
        ...
        int randomChildren = WorldConfigManager.Instance.isTutorialWorld ? demoChildCountWeights.PickRandomElementGivenWeights() : childCountWeights.PickRandomElementGivenWeights();
