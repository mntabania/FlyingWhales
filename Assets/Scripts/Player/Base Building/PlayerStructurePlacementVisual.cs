...
public class PlayerStructurePlacementVisual : MonoBehaviour {
    ...
    public void Initialize(Camera p_camera) {
        ...
        STRUCTURE_TYPE.THE_PORTAL, STRUCTURE_TYPE.BEHOLDER, STRUCTURE_TYPE.BIOLAB, STRUCTURE_TYPE.DEFILER, STRUCTURE_TYPE.TORTURE_CHAMBERS, STRUCTURE_TYPE.KENNEL, STRUCTURE_TYPE.MEDDLER, STRUCTURE_TYPE.SPIRE, STRUCTURE_TYPE.MANA_PIT, STRUCTURE_TYPE.MARAUD,
