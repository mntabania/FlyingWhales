...
public class PlayerStructurePlacementVisual : MonoBehaviour {
    ...
    public void Initialize(Camera p_camera) {
        List<STRUCTURE_TYPE> playerStructureTypes = new List<STRUCTURE_TYPE>() {
            STRUCTURE_TYPE.THE_PORTAL, STRUCTURE_TYPE.EYE, STRUCTURE_TYPE.BIOLAB, STRUCTURE_TYPE.DEFILER, STRUCTURE_TYPE.TORTURE_CHAMBERS, STRUCTURE_TYPE.KENNEL, STRUCTURE_TYPE.MEDDLER, STRUCTURE_TYPE.SPIRE, STRUCTURE_TYPE.MANA_PIT,
