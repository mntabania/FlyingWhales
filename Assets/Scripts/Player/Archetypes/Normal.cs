...
namespace Archetype {
    public class Normal : PlayerArchetype {
        public Normal() : base(PLAYER_ARCHETYPE.Normal) {
            ...
            demonicStructuresSkills = new List<PLAYER_SKILL_TYPE>() { PLAYER_SKILL_TYPE.SNOOPER, PLAYER_SKILL_TYPE.KENNEL, PLAYER_SKILL_TYPE.CRYPT, PLAYER_SKILL_TYPE.MEDDLER, PLAYER_SKILL_TYPE.TORTURE_CHAMBERS, PLAYER_SKILL_TYPE.DEMONIC_PRISON, PLAYER_SKILL_TYPE.SPIRE, PLAYER_SKILL_TYPE.MARAUD, PLAYER_SKILL_TYPE.MANA_PIT, PLAYER_SKILL_TYPE.DEFENSE_POINT, };
