...
namespace Plague.Symptom {
    ...
    public static class PlagueSymptomExtensions{
        ...
        public static string GetSymptomTooltip(this PLAGUE_SYMPTOM p_symptom) {
            switch (p_symptom) {
                case PLAGUE_SYMPTOM.Paralysis:
                    return $"The Plague may eventually render about a quarter of Plague victims paralyzed. This symptom produces {UtilityScripts.Utilities.ChaoticEnergyIcon()}Chaos Orbs.";
                case PLAGUE_SYMPTOM.Vomiting:
                    return $"The Plague may sometimes trigger vomiting. This symptom produces {UtilityScripts.Utilities.ChaoticEnergyIcon()}Chaos Orbs.";
                case PLAGUE_SYMPTOM.Lethargy:
                    return $"Plagued victims will always becomes Lethargic after waking up or sitting down. This symptom produces {UtilityScripts.Utilities.ChaoticEnergyIcon()}Chaos Orbs.";
                case PLAGUE_SYMPTOM.Seizure:
                    return $"The Plague may sometimes trigger seizures. This symptom produces \n{UtilityScripts.Utilities.ChaoticEnergyIcon()}Chaos Orbs.";
                case PLAGUE_SYMPTOM.Insomnia:
                    return $"Plagued victims have insomnia which sometimes prevent them from having restful sleep. This symptom produces {UtilityScripts.Utilities.ChaoticEnergyIcon()}Chaos Orbs.";
                case PLAGUE_SYMPTOM.Poison_Cloud:
                ...
                case PLAGUE_SYMPTOM.Sneezing:
                    return $"The Plague may sometimes trigger sneezing. Sneezing may trigger airborne transmission. This symptom produces {UtilityScripts.Utilities.ChaoticEnergyIcon()}Chaos Orbs.";
                case PLAGUE_SYMPTOM.Depression:
                    return $"Plagued victims have depression which sometimes prevent them from doing entertaining activities. This symptom produces {UtilityScripts.Utilities.ChaoticEnergyIcon()}Chaos Orbs.";
                case PLAGUE_SYMPTOM.Hunger_Pangs:
