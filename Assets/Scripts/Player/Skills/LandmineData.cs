...
public class LandmineData : SpellData {
    ...
    public override string description { get { return "This Spell places an invisible trap on a target unoccupied tile. Any character that walks into the tile will activate it, causing it to explode and deal Fire damage to a small area around it."; } }
