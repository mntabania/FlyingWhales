...
public class SeizeMonsterData : PlayerAction {
    ...
    public override string description => $"This Action can be used to take a {UtilityScripts.Utilities.MonsterIcon()}Monster and then transfer it to an unoccupied tile.";
