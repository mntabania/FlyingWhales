...
public class SeizeMonsterData : PlayerAction {
    ...
    public override bool CanPerformAbilityTowards(Character targetCharacter) {
        ...
        if (canPerform) {
            return !PlayerManager.Instance.player.seizeComponent.hasSeizedPOI && !targetCharacter.traitContainer.HasTrait("Blessed") && !targetCharacter.traitContainer.HasTrait("Hibernating");
        }
        return canPerform;
    }
    #endregion
