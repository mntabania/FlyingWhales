...
public class PyrophobiaData : SpellData {
    ...
    public override string description => "TThis Affliction will make a Villager fear fire. Pyrophobic Villagers will always flee or cower whenever it gets close to a fire.";
