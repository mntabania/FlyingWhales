...
public static class PlayerDB {
    ...
    public static List<SPELL_TYPE> spells = new List<SPELL_TYPE>() {
        ...
        SPELL_TYPE.POISON_BLOOM, SPELL_TYPE.LANDMINE, SPELL_TYPE.TERRIFYING_HOWL, SPELL_TYPE.WIND_BLAST, SPELL_TYPE.ICETEROIDS
    };
    ...
    public static List<SPELL_TYPE> afflictions = new List<SPELL_TYPE>() { 
        ...
        SPELL_TYPE.VAMPIRISM, SPELL_TYPE.ZOMBIE_VIRUS, /*SPELL_TYPE.CURSED_OBJECT,*/
    };
