...
namespace Factions {
    public class FactionQuest : IJobOwner {
        ...
        public FactionQuest(Faction factionOwner, Region region) {
        ...
        public FactionQuest(SaveDataQuest data) {
            name = data.name;
    ...
    public class SaveDataQuest {
        ...
        public virtual void Save(FactionQuest factionQuest) {
            name = factionQuest.name;
            description = factionQuest.description;
            factionOwnerID = factionQuest.factionOwner.id;
            regionID = factionQuest.region.id;
            isActivated = factionQuest.isActivated;
        ...
        public virtual FactionQuest Load() {
            string noSpacesName = UtilityScripts.Utilities.RemoveAllWhiteSpace(name);
            FactionQuest factionQuest = System.Activator.CreateInstance(System.Type.GetType(noSpacesName), this) as FactionQuest;
