...
public class DivineInterventionFactionQuest : FactionQuest {
    ...
    public DivineInterventionFactionQuest(Faction factionOwner, Region region) : base(factionOwner, region) {
    ...
    public DivineInterventionFactionQuest(SaveDataQuest data) : base(data) {
    }
