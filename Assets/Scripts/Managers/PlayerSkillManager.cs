...
public class PlayerSkillManager : MonoBehaviour {
    ...
    public List<PLAYER_SKILL_TYPE> constantSkills = new List<PLAYER_SKILL_TYPE> { PLAYER_SKILL_TYPE.AFFLICT, PLAYER_SKILL_TYPE.BUILD_DEMONIC_STRUCTURE, PLAYER_SKILL_TYPE.UNSUMMON, 
        ...
        PLAYER_SKILL_TYPE.LET_GO, PLAYER_SKILL_TYPE.FULL_HEAL, PLAYER_SKILL_TYPE.CREATE_BLACKMAIL
    };
    ...
    public PLAYER_SKILL_TYPE[] allPlayerActions = { PLAYER_SKILL_TYPE.ZAP, PLAYER_SKILL_TYPE.RAISE_DEAD, PLAYER_SKILL_TYPE.DESTROY, PLAYER_SKILL_TYPE.IGNITE, PLAYER_SKILL_TYPE.POISON
            ...
            , PLAYER_SKILL_TYPE.DRAIN_SPIRIT, PLAYER_SKILL_TYPE.LET_GO, PLAYER_SKILL_TYPE.FULL_HEAL, PLAYER_SKILL_TYPE.CREATE_BLACKMAIL
    };
    ...
    [NonSerialized]
    public PLAYER_SKILL_TYPE[] allDemonicStructureSkills = { PLAYER_SKILL_TYPE.MEDDLER, PLAYER_SKILL_TYPE.BEHOLDER, /*SPELL_TYPE.CRYPT,*/
        PLAYER_SKILL_TYPE.KENNEL, /*SPELL_TYPE.OSTRACIZER,*/ PLAYER_SKILL_TYPE.TORTURE_CHAMBERS, /*SPELL_TYPE.DEMONIC_PRISON, PLAYER_SKILL_TYPE.DEFILER,*/ PLAYER_SKILL_TYPE.BIOLAB, PLAYER_SKILL_TYPE.SPIRE, PLAYER_SKILL_TYPE.MANA_PIT, PLAYER_SKILL_TYPE.MARAUD, PLAYER_SKILL_TYPE.DEFENSE_POINT,
    };
