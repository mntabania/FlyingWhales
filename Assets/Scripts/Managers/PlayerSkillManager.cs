...
public class PlayerSkillManager : MonoBehaviour {
    ...
    public List<PLAYER_SKILL_TYPE> constantSkills = new List<PLAYER_SKILL_TYPE> { PLAYER_SKILL_TYPE.AFFLICT, PLAYER_SKILL_TYPE.BUILD_DEMONIC_STRUCTURE/*, PLAYER_SKILL_TYPE.UNSUMMON*/, 
        ...
        PLAYER_SKILL_TYPE.LET_GO, PLAYER_SKILL_TYPE.FULL_HEAL, PLAYER_SKILL_TYPE.CREATE_BLACKMAIL, PLAYER_SKILL_TYPE.UNLOCK_ABILITIES, PLAYER_SKILL_TYPE.SNATCH_VILLAGER, PLAYER_SKILL_TYPE.SNATCH_MONSTER,
        PLAYER_SKILL_TYPE.RAID, PLAYER_SKILL_TYPE.UPGRADE_ABILITIES, PLAYER_SKILL_TYPE.DEFEND
    };
    ...
    public PLAYER_SKILL_TYPE[] allPlayerActions = { PLAYER_SKILL_TYPE.ZAP, PLAYER_SKILL_TYPE.RAISE_DEAD, PLAYER_SKILL_TYPE.DESTROY, PLAYER_SKILL_TYPE.IGNITE, PLAYER_SKILL_TYPE.POISON
            ...
            , PLAYER_SKILL_TYPE.DRAIN_SPIRIT, PLAYER_SKILL_TYPE.LET_GO, PLAYER_SKILL_TYPE.FULL_HEAL, PLAYER_SKILL_TYPE.CREATE_BLACKMAIL, PLAYER_SKILL_TYPE.UNLOCK_ABILITIES
            , PLAYER_SKILL_TYPE.SNATCH_VILLAGER, PLAYER_SKILL_TYPE.SNATCH_MONSTER, PLAYER_SKILL_TYPE.RAID, PLAYER_SKILL_TYPE.UPGRADE_ABILITIES, PLAYER_SKILL_TYPE.DEFEND
    };
