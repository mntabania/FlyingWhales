...
public class PlayerSkillManager : MonoBehaviour {
    ...
    public PLAYER_SKILL_TYPE[] allDemonicStructureSkills = { PLAYER_SKILL_TYPE.MEDDLER, PLAYER_SKILL_TYPE.BEHOLDER, /*SPELL_TYPE.CRYPT,*/
        PLAYER_SKILL_TYPE.KENNEL, /*SPELL_TYPE.OSTRACIZER,*/ PLAYER_SKILL_TYPE.TORTURE_CHAMBERS, /*SPELL_TYPE.DEMONIC_PRISON,*/ PLAYER_SKILL_TYPE.DEFILER, PLAYER_SKILL_TYPE.BIOLAB, PLAYER_SKILL_TYPE.SPIRE, PLAYER_SKILL_TYPE.MANA_PIT,
    };
