...
public class PlayerSkillManager : MonoBehaviour {
    ...
    public PLAYER_SKILL_TYPE[] allSpells = { PLAYER_SKILL_TYPE.METEOR
            ...
            , PLAYER_SKILL_TYPE.SPAWN_BOULDER, PLAYER_SKILL_TYPE.WATER_BOMB, PLAYER_SKILL_TYPE.MANIFEST_FOOD
    ...
    public PLAYER_SKILL_TYPE[] allPlayerActions = { PLAYER_SKILL_TYPE.ZAP, PLAYER_SKILL_TYPE.RAISE_DEAD, PLAYER_SKILL_TYPE.DESTROY, PLAYER_SKILL_TYPE.IGNITE, PLAYER_SKILL_TYPE.POISON
            , PLAYER_SKILL_TYPE.TORTURE, PLAYER_SKILL_TYPE.SUMMON_MINION, PLAYER_SKILL_TYPE.STOP, PLAYER_SKILL_TYPE.SEIZE_OBJECT, PLAYER_SKILL_TYPE.SEIZE_CHARACTER, PLAYER_SKILL_TYPE.SEIZE_MONSTER
            , PLAYER_SKILL_TYPE.LEARN_SPELL
            ...
            , PLAYER_SKILL_TYPE.FOUND_CULT, PLAYER_SKILL_TYPE.UPGRADE,
    };
    ...
    [NonSerialized]
    public PLAYER_SKILL_TYPE[] allDemonicStructureSkills = { /*SPELL_TYPE.MEDDLER,*/ PLAYER_SKILL_TYPE.EYE, /*SPELL_TYPE.CRYPT,*/
