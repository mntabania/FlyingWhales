...
public class CharacterClassManager : BaseMonoBehaviour {
    ...
    //                    if (bed != null) {
    //                        if (character.traitContainer.GetNormalTrait<Trait>("Vampire") != null) {
    ...
    //                log += "\n  -RNG roll: " + chance;
    //                if (chance < 25) {
    //                    List<Relatable> positiveRelatables = character.relationshipContainer.GetRelatablesWithRelationship(RELATIONSHIP_EFFECT.POSITIVE);
