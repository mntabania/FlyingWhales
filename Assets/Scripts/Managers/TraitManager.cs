...
public class TraitManager : MonoBehaviour {
    ...
    public static string[] instancedTraits = new string[] {
        //"Builder",
        "Grudge", "Patrolling Character", "Reanimated", "Restrained",
        //"Assaulter",
        //"AttemptedMurderer",
        ...
        //"Thief",
        "Unconscious", "Zapped", "Spooked", "Jolted", "Taunted","Cannibal","Lethargic","Berserk Buff",
        //"Aberration",
        "Dead","Disabled","Invisible","Unfaithful","Drunk","Burning","Burnt","Agoraphobic","Infected","Music Lover", "Music Hater", "Psychopath","Plagued","Vigilant","Curious",
        //"Healer",
        "Diplomatic",
        // "AccidentProne",
        ...
        //"Disillusioned",
        "Chaste","Lustful","Edible","Elemental Master","Paralyzed","Malnourished","Withdrawal","Suicidal","Criminal","Dazed","Hiding","Bored","Overheating","Freezing",
        "Frozen","Ravenous","Feeble","Forlorn","Accident Prone","Disoriented","Consumable",
        };
