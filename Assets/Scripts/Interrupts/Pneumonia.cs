...
namespace Interrupts {
    public class Pneumonia : Interrupt {
        ...
        public override bool ExecuteInterruptEndEffect(InterruptHolder interruptHolder) {
            if (ChanceData.RollChance(CHANCE_TYPE.Plagued_Event_Pneumonia) && interruptHolder.actor.homeSettlement != null && 
            ...
            interruptHolder.actor.Death("Pneumonia", _deathLog: interruptHolder.effectLog, interrupt: this, isPlayerSource: true);
            return true;
        }
