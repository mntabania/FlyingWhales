...
namespace Interrupts {
    public class Stroke : Interrupt {
        public Stroke() : base(INTERRUPT.Stroke) {
            duration = 4;
        ...
        public override bool ExecuteInterruptEndEffect(InterruptHolder interruptHolder) {
            if (ChanceData.RollChance(CHANCE_TYPE.Plagued_Event_Stroke) && interruptHolder.actor.homeSettlement != null && 
        ...
        public override string ReactionToActor(Character actor, IPointOfInterest target,
            ...
            if (status == REACTION_STATUS.WITNESSED && actor.homeSettlement != null && actor.homeSettlement is NPCSettlement settlement) {
                //When a resident has been witnessed to die due to Stroke, the Settlement will be flagged as Plagued
